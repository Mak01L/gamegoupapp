  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-400 text-sm">
          {t(
            ...
            'Únete a nuestra comunidad y ayuda a hacer GameGoUp aún mejor'
          )}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* Widget de donación */}
        {showDonation && <DonationWidget variant="card" />}{' '}
        {/* Anuncios de gaming */}
        {showAds && (
          <>
            <AdManager
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-sm">
              {t(
                ...
                'Recibe las últimas noticias y actualizaciones de GameGoUp'
              )}
            </p>
          </div>
          <div className="flex gap-2">
            <input
              type="email"
              placeholder={t(
                'community.newsletter.emailPlaceholder',
                'tu@email.com'
              )}
